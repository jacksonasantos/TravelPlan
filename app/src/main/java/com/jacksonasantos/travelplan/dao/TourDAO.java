...
public class TourDAO extends DbContentProvider implements TourISchema, TourIDAO {
    ...
    protected Tour cursorToEntity(Cursor c) {
        ...
        if (c != null) {
            ...
            if (c.getColumnIndex(TOUR_MARKER_ID) != -1)       if (c.getInt(c.getColumnIndexOrThrow(TOUR_MARKER_ID)) == 0) t.setMarker_id(null);
                                                              else t.setMarker_id(c.getInt(c.getColumnIndexOrThrow(TOUR_MARKER_ID)));
            ...
            if (c.getColumnIndex(TOUR_TOUR_SEQUENCE) != -1)   {t.setTour_sequence(c.getInt(c.getColumnIndexOrThrow(TOUR_TOUR_SEQUENCE))); }
    ...
    private void setContentValue(Tour t) {
        ...
        initialValues.put(TOUR_TOUR_SEQUENCE, t.tour_sequence);
