...
public class VehicleDAO extends DbContentProvider implements VehicleISchema, VehicleIDAO {
    ...
    protected Vehicle cursorToEntity(Cursor c) {
        ...
        if (c != null) {
            ...
            if (c.getColumnIndex(VEHICLE_VEHICLE_OWNER_ID) != -1)           if (c.getInt(c.getColumnIndexOrThrow(VEHICLE_VEHICLE_OWNER_ID)) == 0) v.setVehicle_owner_id(null);
                                                                            else v.setVehicle_owner_id(c.getInt(c.getColumnIndexOrThrow(VEHICLE_VEHICLE_OWNER_ID)));
    ...
    private void setContentValue(Vehicle v) {
        ...
        initialValues.put(VEHICLE_VEHICLE_OWNER_ID, v.vehicle_owner_id);
