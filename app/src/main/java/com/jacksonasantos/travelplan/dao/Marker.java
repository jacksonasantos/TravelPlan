...
public class Marker {
    ...
    @NonNull
    @Override
    public String toString() { return sequence==null||sequence==0?"":sequence+"-"+marker_type+"-"+city; } // TODO - Alterar o marker_type pelo texto do array  - context.getResources().getStringArray(R.array.marker_type_array)[marker_type];
