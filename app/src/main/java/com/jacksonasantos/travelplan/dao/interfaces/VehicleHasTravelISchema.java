...
public interface VehicleHasTravelISchema {
    ...
    String VEHICLE_HAS_TRAVEL_LAST_ODOMETER = "last_odometer";
    ...
    // Version 72
    String ALTER_TABLE_VEHICLE_HAS_TRAVEL_V72 = "ALTER TABLE " + VEHICLE_HAS_TRAVEL_TABLE + " ADD COLUMN " + VEHICLE_HAS_TRAVEL_LAST_ODOMETER + " INTEGER ";
    ...
    String[] VEHICLE_HAS_TRAVEL_COLUMNS = new String[] {
            ...
            VEHICLE_HAS_TRAVEL_LAST_ODOMETER,
