...
public class AccountFragment extends Fragment {
    ...
    public void onResume() {
        ...
        RecyclerView listAccount = this.requireView().findViewById(R.id.list);
        AccountListAdapter adapter = new AccountListAdapter(Database.mAccountDao.fetchAllAccount(), getContext());
        listAccount.setAdapter(adapter);
        listAccount.setLayoutManager(new LinearLayoutManager(getContext()));
        listAccount.addItemDecoration(new DividerItemDecoration(requireContext(), DividerItemDecoration.VERTICAL));
