...
public interface VehicleISchema {
    ...
    // Version 6
    String ALTER_TABLE_VEHICLE_V7_1 = "ALTER TABLE " + VEHICLE_TABLE + " ADD COLUMN " + VEHICLE_DT_ACQUISITION + " LARGEINT";
    String ALTER_TABLE_VEHICLE_V7_2 = "ALTER TABLE " + VEHICLE_TABLE + " ADD COLUMN " + VEHICLE_DT_SALE + " LARGEINT";
    String ALTER_TABLE_VEHICLE_V7_3 = "ALTER TABLE " + VEHICLE_TABLE + " ADD COLUMN " + VEHICLE_DT_ODOMETER + " LARGEINT";
